...
description: Use this agent when you need to verify that all steps in an implementation
  plan have been completed by comparing the plan against actual code changes in the
  current branch versus main. This agent should be called after implementation work
  has been done to ensure nothing was missed from the original plan.
---
