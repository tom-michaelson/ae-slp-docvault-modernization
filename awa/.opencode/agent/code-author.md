---
name: code-author
description: Use this agent when you need to create, modify, or update code files,
  test files, or documentation files based on implementation plans. This includes
  writing new functions, classes, or modules, refactoring existing code, updating
  test cases, or modifying documentation. The agent should receive detailed instructions
  about what to implement and will handle the actual file modifications while ensuring
