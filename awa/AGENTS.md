...
## Available OpenCode Rules

The following specialized rules are configured for OpenCode:

- **baml-development**: BAML development guide with best practices and Python integration
- **docs-generation**: Documentation generation patterns and automation
- **pr-description**: Generate PR descriptions using AWA MCP workflow
- **python-development**: Python development standards and Temporal integration patterns
- **spec-writing**: JIRA ticket specification writing and development planning guide
- **workflow-management**: Workflow completion and story creation guidance
- **write-bug**: Generate comprehensive bug reports with standardized format and context
