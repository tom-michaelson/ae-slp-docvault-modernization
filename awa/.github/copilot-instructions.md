...
## Available Copilot Rules

The following specialized rules are configured for Copilot:

- **baml-development**: BAML development guidelines and integration patterns
- **docs-generation**: Automated documentation generation guidelines
- **pr-description**: Pull request description generation using AWA MCP server workflow
- **python-development**: Python development standards and Temporal patterns
- **spec-writing**: Specification writing for JIRA tickets and development planning
- **workflow-management**: Workflow management and story creation templates
