...
description: Use this agent when you need to initialize a freshly cloned repository by running setup commands. This agent should be triggered immediately after cloning a repository to ensure all dependencies and configurations are properly set up before any development work begins.
model: sonnet
color: blue
---
