---
name: test-runner
description: Use this agent when you need to execute automated tests and get a focused report on test results. This agent should be called after code changes are made, before committing changes, during CI/CD pipeline validation, or when explicitly asked to verify that tests are passing.
model: sonnet
color: blue
---
