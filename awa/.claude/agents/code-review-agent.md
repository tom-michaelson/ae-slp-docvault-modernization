...
description: Use this agent when you need to review code changes that have been made on the current branch compared to the main branch. This agent should be invoked after implementing features or fixes to ensure code quality, adherence to project standards, and completeness of requirements. Examples:
model: sonnet
color: blue
---
