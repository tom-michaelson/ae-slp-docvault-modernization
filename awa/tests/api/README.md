...
For detailed information about the test generation system, custom generators, and extending the framework, see [generation/DEVELOPER.md](generation/DEVELOPER.md).

## Related Documentation

- **[Developer Guide](generation/DEVELOPER.md)** - Test generation system implementation
- **[Main Project Documentation](../../docs/README.md)** - AWA project documentation
