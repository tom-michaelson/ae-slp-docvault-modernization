...
+print('also updated')"""
    ...
    async def test_get_changed_files_with_empty_result(
        ...
        with patch("workflows.test_doctor.test_doctor_workflow.awa_activity.invoke_mcp_tool") as mock_invoke:
...
index 555..666 100644"""
        ...
        with (
            patch("workflows.test_doctor.test_doctor_workflow.awa_activity.read_file", mocks["read_file"]),
            patch("workflows.test_doctor.test_doctor_workflow.json.loads", mocks["json_loads"]),
            patch(
                "workflows.test_doctor.test_doctor_workflow.awa_general.get_workflow_paths",
                mocks["get_workflow_paths"],
            ),
            patch("workflows.test_doctor.test_doctor_workflow.workflow.info", mocks["workflow_info"]),
            patch(
                "workflows.test_doctor.test_doctor_workflow.awa_activity.invoke_mcp_tool",
                mocks["invoke_mcp_tool"],
            ),
            patch(
                "workflows.test_doctor.test_doctor_workflow.awa_workflow.run_with_controlled_concurrency",
