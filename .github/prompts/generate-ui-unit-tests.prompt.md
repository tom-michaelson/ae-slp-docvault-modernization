...
```json
{
  "itemKey": "document-list-page",
  "generatedAt": "2026-04-24T10:00:00Z",
  "attempts": 1,
  "passed": true,
  "testFiles": [
    "target_repo/source/ui/src/app/pages/documents/document-list.component.spec.ts",
    "target_repo/source/ui/src/app/pages/documents/document.service.spec.ts"
  ],
  "acCoverage": [
    {"scenario": "User lands on documents page and sees list", "test": "DocumentListComponent should render documents on load"},
    {"scenario": "User filters documents by status", "test": "DocumentListComponent should filter by selected status"}
  ],
  "failingTests": []
}
```
