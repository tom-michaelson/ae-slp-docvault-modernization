...
**This command maps a page to its component tree for the angular-dotnet target stack.**
...
```
/develop.analyze-page-components page_key=document-list-page \
  docs_dir=/.../docs legacy_dir=/.../legacy \
  output_path=/.../docs/entry-points/ui-pages/document-list-page/page-analysis.json
```
...
| `api-endpoint` | ASP.NET Core REST endpoint |

If the Discover inventory includes items of other types (triggers, batch jobs),
**skip them with a warning**. They're out of scope for angular-dotnet.
