...
| `target_stack` *(optional)* | Defaults to `angular-dotnet` |

Example invocation:

```
/develop.generate-page-plan page_key=document-list-page domain=documents \
  legacy_dir=/.../legacy \
  page_analysis_path=/.../docs/entry-points/ui-pages/document-list-page/page-analysis.json \
  output_json_path=/.../docs/entry-points/ui-pages/document-list-page/page-plan.json \
  output_md_path=/.../docs/entry-points/ui-pages/document-list-page/page-plan.md
```
...
Our target stack is **Angular + .NET** only. Two item types:
...
```json
{
  "pageKey": "document-list-page",
  "domain": "documents",
  "batches": [
    {
      "batchId": "e2e-document-list-page-apis",
      "name": "Layer 1: API Endpoints",
      "items": [
        {
          "key": "list-documents-paged",
          "type": "api-endpoint",
          "functionalSpecPath": "/abs/.../docs/entry-points/api-endpoints/list-documents-paged/functional-spec.md",
          "dependencies": []
        }
      ],
      "branchName": null,
    ...
    {
      "batchId": "e2e-document-list-page-ui",
      "name": "Layer 2: UI Features",
      "items": [
        {
          "key": "document-list-page",
          "type": "ui-feature",
          "functionalSpecPath": "/abs/.../docs/entry-points/ui-features/document-list-page/functional-spec.md",
          "dependencies": ["list-documents-paged"]
        }
      ],
      "branchName": null,
      "pushed": false,
...
|-----|------|--------------|
| 1 | list-documents-paged | — |

### Layer 2: UI Features ({batchId})

| Seq | Item | Dependencies |
|-----|------|--------------|
| 2 | document-list-page | list-documents-paged |
...
- Log a warning: `"Item {key} has unsupported type {type}; skipping for angular-dotnet stack"`.
