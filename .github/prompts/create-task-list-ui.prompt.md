...
- [ ] **1. Types** — create
      `target_repo/source/ui/src/app/pages/documents/document.model.ts`.
      Acceptance: `npm run build` passes.
- [ ] **2. Service** — `document.service.ts` exposing `listDocuments(...)`.
- [ ] **3. Presentational: document row** — …
- [ ] **4. Container: DocumentListComponent** — …
...
| --- | --- |
| User lands on documents page and sees list | 4, 7 |
| User filters documents by status | 4, 5, 8 |
| ... | ... |
```
