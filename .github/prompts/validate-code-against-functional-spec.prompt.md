  ...
  "acs": [
    {
      ...
      "verdict": "PASS",
      "evidence": "DocumentServiceTests.UploadDocument_CreatesDocumentSuccessfully"
    },
    {
      "scenario": "Upload with unknown owner",
      "verdict": "FAIL",
      "evidence": "No test found covering unknown ownerId; handler returns 500 instead of 404."
    }
  ]
}
```
