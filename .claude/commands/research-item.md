...
| `target_repo_dir` | Absolute path to the Angular + Spring Boot target repo |
...
- Current state of the target repo:
  - API: `{target_repo_dir}/source/api/src/main/java/com/slalom/modernization/...`
